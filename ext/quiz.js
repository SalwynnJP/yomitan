...
function loadDeckPaths() {
  ...
  // Définir quels decks nécessitent le mode QCM
  const qcmRequiredDecks = ['ono', 'jg1', 'jg2', 'yj1', 'yj2', 'yj3', 'yj1', 'yj2', 'yj3'];
...
// Activer le mode QCM si au moins un deck le nécessite
  ...
  if (hasQCMRequiredDeck && state.selectedDeckIndices.length === 1) {
    ...
    // Désactiver le mode QCM si le deck ne le nécessite pas
  ...
  updateRangeLabel();
  showQuestion(); // Cette fonction gère maintenant tout l'affichage
}
